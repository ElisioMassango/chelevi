    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
        ...
        <div className="space-y-4">
          <img
            src="https://chelevi.sparktechnology.cloud/chelevi/Logos/CHE-LEVI-01.png"
            alt="CheLevi"
            className="w-40"
          />
          <h3 className="text-lg font-semibold text-gray-900">
            Fica por dentro + Ganha 15% de desconto
          </h3>
          <p className="text-gray-600 text-sm">
            Subscreve com o teu telemóvel e email para receber novidades e ofertas exclusivas da CheLevi.
          </p>
        ...
        <div className="space-y-4">
          ...
          <ul className="space-y-2">
            ...
            <li><Link to="/gift-card" className="text-sm text-gray-600 hover:text-gray-900">Saldo do Cartão-Presente</Link></li>
          </ul>
        </div>
    ...
    <div className="border-t border-gray-200 bg-gray-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
        <div className="flex flex-col md:flex-row items-center justify-between gap-6">
          {/* Logo/Nome */}
          <Link to="/" className="text-xl font-bold text-gray-900" aria-label="CheLevi — Página inicial">
            CHELEVI
          </Link>
          ...
          <div className="flex items-center space-x-4">
            ...
            <a href="#" aria-label="YouTube" className="text-gray-600 hover:text-gray-900">YouTube</a>
